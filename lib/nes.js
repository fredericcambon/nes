...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PPU = __webpack_require__(11);
	
	var _PPU2 = _interopRequireDefault(_PPU);
	
	var _ROM = __webpack_require__(13);
	...
	var _Notifier2 = __webpack_require__(50);
	...
	var Console = function (_Notifier) {
	  ...
	  _createClass(Console, [{
	    key: "loadROM",
	    value: function loadROM(path) {
	      // TODO: Should directly take in the data, not the path
	      return (0, _Request2.default)(path).then(function (res) {
	        this.rom = new _ROM2.default(res.data);
	    ...
	    key: "loadROMData",
	    value: function loadROMData(data) {
	      // TODO: Should directly take in the data, not the path
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CPUMemory = __webpack_require__(5);
	...
	var _modes = __webpack_require__(8);
	
	var _opcodes = __webpack_require__(10);
...
/***/ (function(module, exports) {
	...
	function readTile(tileData, attributeTableByte, lowTileByte, highTileByte, reversed, flush) {
	  /**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PPUMemory = __webpack_require__(12);
	...
	var PPU = function () {
	  ...
	  _createClass(PPU, [{
	    ...
	    value: function normalRenderingMode(pos, colorPos, c, isBackgroundPixel) {
	      this.setColorToBuffer(this.frameBuffer, colorPos, c);
	    }
	  }, {
	    key: "splitRenderingMode",
	    value: function splitRenderingMode(pos, colorPos, c, isBackgroundPixel) {
	    ...
	    value: function renderPixel() {
	      ...
	      if (x < 8 && this.fShowLeftSprites === 0) {
	        ...
	        var _getCurrentSpritePixe = this.getCurrentSpritePixel(),
	            _getCurrentSpritePixe2 = _slicedToArray(_getCurrentSpritePixe, 2),
	            i = _getCurrentSpritePixe2[0],
	            spriteColor = _getCurrentSpritePixe2[1];
	      }
	      ...
	      var c = _constants.COLORS[this.memory.paletteTable.read8(color)];
	      var pos = y * 256 + x;
	      var colorPos = pos * 4;
	    ...
	    key: "fetchSpritePattern",
	    value: function fetchSpritePattern(tileData, i, row) {
	      ...
	      (0, _utils.readTile)(tileData, a, lowTileByte, highTileByte, (attributes & 0x40) === 0x40, true);
	    }
	  }, {
	    key: "fetchAndStoreSprites",
	    value: function fetchAndStoreSprites() {
	      /**
	    ...
	    key: "fetchAndStoreBackground",
	    value: function fetchAndStoreBackground() {
	      /**
	      ...
	      (0, _utils.readTile)(this.tileData, attributeTableByte, lowTileByte, highTileByte, false, false);
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NROM = __webpack_require__(14);
	
	var _NROM2 = _interopRequireDefault(_NROM);
	
	var _MMC = __webpack_require__(17);
	
	var _MMC2 = _interopRequireDefault(_MMC);
	
	var _MMC3 = __webpack_require__(19);
	
	var _MMC4 = _interopRequireDefault(_MMC3);
	
	var _UXROM = __webpack_require__(20);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Mapper2 = __webpack_require__(15);
	...
	var NROM = function (_Mapper) {
	    ...
	    */
	    function NROM(rom) {
	        ...
	        return _possibleConstructorReturn(this, (NROM.__proto__ || Object.getPrototypeOf(NROM)).call(this, rom));
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Bank = __webpack_require__(16);
	...
	var BankMemory2 = function () {
	  /*
	     ...
	     */
	  function BankMemory2(data, windowSize, bankFixed) {
	    _classCallCheck(this, BankMemory2);
	  ...
	  _createClass(BankMemory2, [{
	    key: "resolveOffset",
	    value: function resolveOffset(bank) {
	      return bank * this.halfWindowSize;
	    }
	  }, {
	    key: "setSwitchableBank",
	    value: function setSwitchableBank(mode) {
	      this.bankFixed = false;
	      this.swapMode = mode;
	    }
	  }, {
	    key: "setFixedBank",
	    value: function setFixedBank() {
	      this.bankFixed = true;
	    }
	  }, {
	    key: "updateBanks",
	    value: function updateBanks(value) {
	    ...
	    key: "updateLowerBank",
	    value: function updateLowerBank(value) {
	      if (this.bankFixed) {
	    ...
	    key: "updateUpperBank",
	    value: function updateUpperBank(value) {
	      if (this.bankFixed) {
	  ...
	  _createClass(MMC1, [{
	    ...
	    value: function control(value) {
	      ...
	      if (this.chrBankMode === 0) {
	        ...
	        // FIXME: Careful, not really tested
	        this.chr.fixed = false;
	        //this.chr.setSwitchableBank(0);
	      }
	    }
	  }]);
	...
	var MMC3 = function (_Mapper) {
	  ...
	  _createClass(MMC3, [{
	    ...
	    value: function control(addr, value) {
	      /**
	         Controls on MMC3 are a bit odd
	         The registers match a large nbr of addresses, but need to be either
	         odd or even numbers, hence the % 2 checks
	      */
	          ...
	          case 1:
	            {
	              if (this.chrBankMode === 0) {
	                ...
	                //this.chr.switchBank(0x1800, 0x1fff, value);
	              }
	              break;
	            }
	...
	var UXROM = function (_Mapper) {
	    ...
	    */
	    function UXROM(rom) {
	        ...
	        return _possibleConstructorReturn(this, (UXROM.__proto__ || Object.getPrototypeOf(UXROM)).call(this, rom));
	    }
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function keyDown(event) {
	      switch (event.keyCode) {
	        ...
	        case 13:
	          {
	            this.buttons[_constants.BUTTONS.START] = 1;
	            break;
	          }
	        // Select / Shift
	        case 16:
	          {
	            this.buttons[_constants.BUTTONS.SELECT] = 1;
	            break;
	          }
	        // A
	        case 88:
	          {
	            this.buttons[_constants.BUTTONS.A] = 1;
	            break;
	          }
	        // B
	        case 67:
	          {
	            this.buttons[_constants.BUTTONS.B] = 1;
	            break;
	          }
	        // Left
	        case 37:
	          {
	            this.buttons[_constants.BUTTONS.LEFT] = 1;
	        ...
	        case 38:
	          {
	            this.buttons[_constants.BUTTONS.UP] = 1;
	            event.preventDefault();
	            break;
	          }
	        // Right
	        case 39:
	          {
	            this.buttons[_constants.BUTTONS.RIGHT] = 1;
	            event.preventDefault();
	            break;
	          }
	        // Down
	        case 40:
	          {
	            this.buttons[_constants.BUTTONS.DOWN] = 1;
	            event.preventDefault();
	            break;
	          }
	      }
	    ...
	    value: function keyUp(event) {
	      switch (event.keyCode) {
	        ...
	        case 13:
	          {
	            this.buttons[_constants.BUTTONS.START] = 0;
	            break;
	          }
	        // Select / Shift
	        case 16:
	          {
	            this.buttons[_constants.BUTTONS.SELECT] = 0;
	            break;
	          }
	        // A
	        case 88:
	          {
	            this.buttons[_constants.BUTTONS.A] = 0;
	            break;
	          }
	        // B
	        case 67:
	          {
	            this.buttons[_constants.BUTTONS.B] = 0;
	            break;
	          }
	        // Left
	        case 37:
	          {
	            this.buttons[_constants.BUTTONS.LEFT] = 0;
	            break;
	          }
	        // Up
	        case 38:
	          {
	            this.buttons[_constants.BUTTONS.UP] = 0;
	            break;
	          }
	        // Right
	        case 39:
	          {
	            this.buttons[_constants.BUTTONS.RIGHT] = 0;
	            break;
	          }
	        // Down
	        case 40:
	          {
	            this.buttons[_constants.BUTTONS.DOWN] = 0;
	            break;
	          }
	      }
	    }
