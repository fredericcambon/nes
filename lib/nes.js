...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Console = function (_Notifier) {
	  ...
	  _createClass(Console, [{
	    key: "loadROMUrl",
	    value: function loadROMUrl(path) {
	      return (0, _Request2.default)(path, true).then(function (res) {
	    ...
	    value: function loadROM(path) {
	      ...
	      return (0, _Request2.default)(path, false).then(function (res) {
	        this.rom = new _ROM2.default(res.data);
	        this.cpu.connectROM(this.rom);
	        this.ppu.connectROM(this.rom);
	        this.reset();
