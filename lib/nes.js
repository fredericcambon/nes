	...
	var PPU = function () {
	  ...
	  _createClass(PPU, [{
	      ...
	      for (var sprite = 0; sprite < 64; sprite++) {
	        ...
	        for (var tileY = 0; tileY < spriteSize; tileY++) {
	          ...
	          for (var tileX = 0; tileX < 8; tileX++) {
	            ...
	            value = ((lowTileData >> tileShiftX & 1) << 1) + (highTileData >> tileShiftX & 1);
	    ...
	    value: function fetchSpritePattern(tileData, i, row) {
	      ...
	      (0, _utils.readTile)(tileData, attributeTableByte, this.lowTileByte, this.highTileByte, isReversedHorizontally, true);
	    }
